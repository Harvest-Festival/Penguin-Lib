...
public class PenguinRecipes extends RecipeProvider {
    ...
    protected void buildShapelessRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        ShapedRecipeBuilder.shaped(PenguinItems.GLASS.get(), 6).define('G', Tags.Items.GLASS_COLORLESS).pattern("G G").pattern("G G").pattern(" G ").unlockedBy("has_glass", has(Blocks.GLASS)).save(consumer, rl("glass"));
